...
def lambda_handler(event, context):
    ...
    process_instances(context, execution_id, key, value)
            ...
            if instance["State"].get('Name') == 'running':
                    for tag in instance.get("Tags", []):
                        ...
                        if tag["Key"] == "AutoShutdown" and tag["Value"] == "True":
                            autoshutdown = True
                        if tag["Key"] == "Environment" and tag["Value"] == "Dev" and autoshutdown == True and key == None and value == None:
                            autoshutdown = False
                        ...
                        elif key != None and value != None and tag["Key"] == key and tag["Value"] == value and autoshutdown == True:
                            autoshutdown = False
                            stop_instances = ec2.stop_instances(
                            InstanceIds=[
                                instance.get("InstanceId")
